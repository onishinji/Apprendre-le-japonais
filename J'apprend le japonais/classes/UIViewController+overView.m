...
const float kUIViewControllerOverViewAnimationDuration = 0.5;
const NSInteger kUIViewControllerOverViewTag = 8208130; // Arbitrary number, so as not to conflict
